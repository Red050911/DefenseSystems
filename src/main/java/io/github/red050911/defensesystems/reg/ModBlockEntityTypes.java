...
public class ModBlockEntityTypes {
    ...
    public static void register() {
        DEFENSE_COMPUTER = Registry.register(Registries.BLOCK_ENTITY_TYPE, DefenseSystems.id("defense_computer"), FabricBlockEntityTypeBuilder.create(
                DefenseComputerBlockEntity::new,
                ModBlocks.DEFENSE_COMPUTER_BLOCK
        ).build(null));
        CAMERA_BOX = Registry.register(Registries.BLOCK_ENTITY_TYPE, DefenseSystems.id("camera_box"), FabricBlockEntityTypeBuilder.create(
        ...
        ANVIL_LAUNCHER = Registry.register(Registries.BLOCK_ENTITY_TYPE, DefenseSystems.id("anvil_launcher"), FabricBlockEntityTypeBuilder.create(
                AnvilLauncherBlockEntity::new,
                ModBlocks.ANVIL_LAUNCHER_BLOCK
        ).build(null));
        TURRET = Registry.register(Registries.BLOCK_ENTITY_TYPE, DefenseSystems.id("turret"), FabricBlockEntityTypeBuilder.create(
                TurretBlockEntity::new,
                ModBlocks.TURRET_BLOCK
        ).build(null));
        RADAR = Registry.register(Registries.BLOCK_ENTITY_TYPE, DefenseSystems.id("radar"), FabricBlockEntityTypeBuilder.create(
