...
public class ModEntityTypes {
    ...
    public static void register() {
        TURRET = Registry.register(Registry.ENTITY_TYPE, DefenseSystems.id("turret"), FabricEntityTypeBuilder.<TurretEntity>create(SpawnGroup.MISC, TurretEntity::new)
                .dimensions(EntityDimensions.fixed(1, 1))
                .fireImmune()
                .build()
        );
        FabricDefaultAttributeRegistry.register(TURRET, TurretEntity.createTurretAttributes());
        BULLET = Registry.register(Registry.ENTITY_TYPE, DefenseSystems.id("bullet"), FabricEntityTypeBuilder.<BulletProjectile>create(SpawnGroup.MISC, BulletProjectile::new)
